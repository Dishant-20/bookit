...
class more_tab_club: UIViewController {
...
//MARK:- TABLE VIEW -
extension more_tab_club: UITableViewDataSource , UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == 0 {
            ...
            let cell:more_tab_club_table_cell = tableView.dequeueReusableCell(withIdentifier: "more_tab_club_table_cell_one") as! more_tab_club_table_cell
            ...
            let cell:more_tab_club_table_cell = tableView.dequeueReusableCell(withIdentifier: "more_tab_club_table_cell_two") as! more_tab_club_table_cell
            ...
            let cell:more_tab_club_table_cell = tableView.dequeueReusableCell(withIdentifier: "more_tab_club_table_cell_eleven") as! more_tab_club_table_cell
        ...
        } else if indexPath.row == 3 { // payment options
            
            let cell:more_tab_club_table_cell = tableView.dequeueReusableCell(withIdentifier: "more_tab_club_table_cell_three") as! more_tab_club_table_cell
            ...
            let cell:more_tab_club_table_cell = tableView.dequeueReusableCell(withIdentifier: "more_tab_club_table_cell_five") as! more_tab_club_table_cell
            ...
            let cell:more_tab_club_table_cell = tableView.dequeueReusableCell(withIdentifier: "more_tab_club_table_cell_four") as! more_tab_club_table_cell
            ...
            let cell:more_tab_club_table_cell = tableView.dequeueReusableCell(withIdentifier: "more_tab_club_table_cell_ten") as! more_tab_club_table_cell
            ...
            let cell:more_tab_club_table_cell = tableView.dequeueReusableCell(withIdentifier: "more_tab_club_table_cell_six") as! more_tab_club_table_cell
            ...
            let cell:more_tab_club_table_cell = tableView.dequeueReusableCell(withIdentifier: "more_tab_club_table_cell_seven") as! more_tab_club_table_cell
            ...
            let cell:more_tab_club_table_cell = tableView.dequeueReusableCell(withIdentifier: "more_tab_club_table_cell_eight") as! more_tab_club_table_cell
            ...
            let cell:more_tab_club_table_cell = tableView.dequeueReusableCell(withIdentifier: "more_tab_club_table_cell_nine") as! more_tab_club_table_cell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.row == 1 {
        ...
        } else if indexPath.row == 2 { // days off
            
             let push = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "club_day_off_id")
             self.navigationController?.pushViewController(push, animated: true)
            
        } else if indexPath.row == 6 { // cashout
            
            let push = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "CashOutVC")
            self.navigationController?.pushViewController(push, animated: true)
            
        } else if indexPath.row == 5 { // bank details
            
             let push = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "bank_details_id")
             self.navigationController?.pushViewController(push, animated: true)
            
        } else if indexPath.row == 4 { // earning
            
            let push = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "earnings_new_id")
            self.navigationController?.pushViewController(push, animated: true)
            ...
            let push = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "HelpVC")
            self.navigationController?.pushViewController(push, animated: true)
            
        } else if indexPath.row == 3 {
            
            let push = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "payment_options_id")
            self.navigationController?.pushViewController(push, animated: true)
...
class more_tab_club_table_cell:UITableViewCell {
